...
namespace XJTU.Common
{
    public static class DesCode
    {
        ...
        /// <returns>密文(base64编码)</returns>
        public static string Encrypt3DES(this string utf8Str, string keyBase64Str = "0nAo+6t79mu6iLF1mxF2jkeNZpGgYA58", string iVBase64Str = "LAGq0oBZUnw=")
        {
            var key = Convert.FromBase64String(keyBase64Str);
            var iv = Convert.FromBase64String(iVBase64Str);
        ...
        /// 生成向量方法：new TripleDESCryptoServiceProvider().GenerateIV()</param>
        /// <returns>原文(UTF8编码)</returns>
        public static string Decrypt3DES(this string base64Str, string keyBase64Str = "0nAo+6t79mu6iLF1mxF2jkeNZpGgYA58", string iVBase64Str = "LAGq0oBZUnw=")
        {
            var key = Convert.FromBase64String(keyBase64Str);
            var iv = Convert.FromBase64String(iVBase64Str);
            ICryptoTransform desEncrypt;
